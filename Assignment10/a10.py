...
class Vector:
    ...
    def get_tuple(self):
        self = str(self).replace("<","(").replace(">",")")
        return eval(self)

    def __add__(self, other):
        self = Vector.get_tuple(self)
        other = Vector.get_tuple(other)
    ...
    def __abs__(self):
        return round(math.sqrt(self*self),3)
...
# for d in data:
#     my_cursor.execute(f'INSERT INTO Weather VALUES {d}')
...
if __name__ == "__main__":
    ...
    # print("\nQuery 6")
    # for i in my_cursor.execute("SELECT (1.0*SUM(High))/COUNT(High), (1.0*SUM(Low))/COUNT(low) FROM Weather"):
    #     print(i)
    ...
    # print("\nQuery 7")
    # for i in my_cursor.execute("SELECT Low, COUNT(Low) FROM Weather GROUP BY Low"):
    #     print(i)
